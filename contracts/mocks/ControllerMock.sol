...
contract ControllerMock is IController {
    ...
    function valueAll() external view override returns (uint256) {
        return token.balanceOf(address(this));
    }

    function utilizeAmount() external override returns (uint256) {
    ...
    function earn(address, uint256 _amount) external override {
